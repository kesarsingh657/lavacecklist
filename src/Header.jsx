      ...
      <div className="h-14 px-4 md:px-6 flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            ...
            <div className="hidden sm:block">
              <h1 className="text-sm font-bold text-white leading-none">Checklist</h1>
            ...
            {navItems.map(([p, l]) => (
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs transition-all ${
                  page === p
                    ? "bg-white text-[#3D8B6E] font-semibold"
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-1.5 bg-[#2A6B52] rounded-lg px-2 py-1">
            <div className="w-6 h-6 rounded-md bg-[#6FAF8F] text-white flex items-center justify-center text-[10px] font-bold">
          ...
          <button onClick={onLogout} className="px-2.5 py-1.5 rounded-lg bg-white text-[#3D8B6E] text-xs font-semibold hover:bg-green-50">
            Logout
          </button>
        </div>
      </div>
